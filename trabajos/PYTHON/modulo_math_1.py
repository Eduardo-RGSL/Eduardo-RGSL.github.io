'''Módulo Math Nativo'''
# Veámos algunas funciones nativas de python
# Round(argumeto1, digitos) redondeo.
# Hay que tener en cuenta que se usa el redondeo bancario:redondeo al número par más próximo cuando es algo,5
